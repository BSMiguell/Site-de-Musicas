...
fetch(json_url)
  ...
  .then((data) => {
      ...
      <div class="rest_card">
        ...
        <div class="cont">
          ...
          <div class="sub">
            <p>${genre}, ${date}</p>
            <p id="h3">
              <span>BSM</span><i class="bi bi-star-fill"></i>${imdb}
            </p>
          </div>
        </div>
      </div>
    ...
    document.getElementById("h3").innerText = data[0].genre;
    document.getElementById("h4").innerText = data[0].date;
    document.getElementById(
      "rate"
    ).innerHTML = `<span>BSM</span><i class="bi bi-star-fill"></i> ${data[0].imdb}`;
